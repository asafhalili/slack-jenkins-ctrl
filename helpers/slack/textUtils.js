...
const MSG_TEXTS = {
    ...
    JOB_STARTED: jobId => `:face_with_cowboy_hat: Yay! I started '${jobId}'`,
    JOB_ENABLED: jobId => `:relaxed: I enabled '${jobId}'`,
    JOB_DISABLED: jobId => `:wink: I disabled '${jobId}'`,
    JOB_ABORTED: jobId => `:boom: I aborted '${jobId}'`,
    JOB_STOPPED: jobId => `:clap: I stopped ${jobId}`,
    JOB_CANCELLED: jobId => `The job with queued ${jobId} cancelled and no longer in the queue`,
